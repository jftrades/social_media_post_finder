...
- Zusätzliche Bibliotheks-B-Roll: keine / nur an ausdrücklich genannten Aussagen / nur falls nach vollständiger Verwendung und Aufteilung aller Tagesclips noch Bildlänge fehlt / beides? Welche B-Roll-Ordner sind erlaubt? `Keine` verbietet Bibliotheks-B-Roll vollständig.
- Bildauswahl: automatisch passend zur gesprochenen Aussage anhand Dateiname plus wenigen Prüfframes / konkrete Reihenfolge und Stellen vorgeben?
...
Voiceover-Systemregel: genau eine Voiceover-Datei plus viele Bildclips. Zuerst alle bestätigten Tagesclips passend zur Aussage und in Tagesreihenfolge verteilen. Bei `keine B-Roll` die nutzbare Gesamtlänge nach dem FlashShutterIntro als Ausgangsbasis prüfen und keinen Tagesclip zugunsten externer Bilder auslassen. Clips über 5 Sekunden liefern zwei bis fünf unterschiedliche, chronologische Schnipsel von etwa 0,8 bis 1,0 Sekunden; ausdrücklich beschleunigte vollständige Clipstrecken laufen stattdessen exakt mit 5×. Erst danach Clips bis einschließlich 5 Sekunden an Anfang und Ende minimal auf die fertige Voiceover-Länge kürzen. Originalton-Einschübe bleiben für die bestätigte Aussage zusammenhängend. FlashShutterIntro ersetzt bei bestätigtem Ja nur die ersten Bilder der normalen Timeline; seine Clips werden anschließend trotzdem regulär verwendet. Voiceover und Musik beginnen bei 0:00. Titel, Untertitel und deren Presets bleiben davon unabhängig und werden danach wie gewählt gerendert.
