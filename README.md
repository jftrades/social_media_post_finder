...
Titel in Level 2 für alle Formate: genauer Wortlaut, Dauer in Sekunden und Snapchat / Max-Readable / Preset 1 / Preset 2 / Preset 3. Snapchat und Max-Readable bleiben unverändert. Preset 1–3 haben drei feste Slots `oben`, `mitte`, `unten`; nur deren Text wird abgefragt. `nix`, `leer`, `kein Text` oder leer blendet den jeweiligen Slot aus. Größe, Position, Font und Schatten sind pro Preset fest; Animation folgt erst nach Designfreigabe. Titeldauer ausdrücklich abfragen. Musikstart ist formatspezifisch: Talking Head 0:30, Voiceover 0:00.
